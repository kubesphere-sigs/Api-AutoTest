...
#     :param image: 镜像名称
#     """
#     url1 = env_url + '/apis/clusters/' + cluster_name + '/apps/v1/namespaces/' + project_name + '/deployments?dryRun=All'
#     url2 = env_url + '/apis/clusters/' + cluster_name + '/apps/v1/namespaces/' + project_name + '/deployments'
...
#     :return:
#     """
#     url = env_url + '/kapis/clusters/' + cluster_name + '/resources.kubesphere.io/v1alpha3/namespaces/' + project_name + '/' + type + '?' + condition
#     response = requests.get(url=url, headers=get_header())
#     return response
...
#     url = env_url + '/kapis/clusters/' + cluster_name + '/resources.kubesphere.io/v1alpha3/namespaces/' + project_name + '/persistentvolumeclaims?name=' + volume_name + '&sortBy=createTime&limit=10'
#     response = requests.get(url=url, headers=get_header())
#     return response


# @allure.step('项目/存储/持久卷声明，删除持久卷声明')
# def step_delete_pvc(cluster_name, project_name, pvc_name):
#     url = env_url + '/api/clusters/' + cluster_name + '/v1/namespaces/' + project_name + '/persistentvolumeclaims/' + pvc_name
#     response = requests.delete(url=url, headers=get_header())
#     return response
